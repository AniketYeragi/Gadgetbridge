...
import nodomain.freeyourgadget.gadgetbridge.activities.GemtecListenActivity;
...
public class GBApplication extends Application {
    private final class RunnableImplementation implements Runnable {
        ...
        private RunnableImplementation(Intent intent) {
            this.intent = intent;
        }
    ...
    public static final String ACTION_GEMTEC = "nodomain.freeyourgadget.gadgetbridge.action.gemtec";
    public static final String ACTION_CONTACTS_CHANGED = "nodomain.freeyourgadget.gadgetbridge.action.contacts_changed";
    public static final String GEMTEC_FALL_DETECTED = "gemtec.fall.detected";
    public static final String COMPANY = "NC Systems";
    public static String GEMTEC_MAC_ADDRESS = "";
    public static String GEMTEC_SCAN_FILTER = "GEMTEC";
    public static int GEMTEC_FALL_COUNTER = -1;
    public static ArrayList<String> GEMTEC_PHONE_NUMBER = new ArrayList<String>();
    public static ArrayList<String> GEMTEC_PHONE_NAME = new ArrayList<String>();
    ...
    public void onCreate() {
        ...
        if (GBApplication.getGBPrefs().getMACAddress() != null) {
            GEMTEC_MAC_ADDRESS = GBApplication.getGBPrefs().getMACAddress();
        }

        try {
            GBApplication.GEMTEC_PHONE_NUMBER = (ArrayList<String>) ObjectSerializer.deserialize(prefs.getString(GBPrefs.CONTACT_NUMBER_LIST, ObjectSerializer.serialize(new ArrayList<String>())));
            GBApplication.GEMTEC_PHONE_NAME = (ArrayList<String>) ObjectSerializer.deserialize(prefs.getString(GBPrefs.CONTACT_NAME_LIST, ObjectSerializer.serialize(new ArrayList<String>())));
        } catch (Exception e) {
        ...
        if (isRunningMarshmallowOrLater()) {
            ...
            // }
            try {
                final Intent intent = new Intent(this, DiscoveryService.class);
                final Handler handler = new Handler();
                handler.postDelayed(new RunnableImplementation(intent), 200);  //start background scan service after 2 seconds. The delay is essential for creating the notification, especially during automatic start of the application after a restart 
        ...
        // if (sharedPrefs.getBoolean("firstrun", true)) {
            try {
                Intent intent = new Intent(this, GemtecListenActivity.class);
