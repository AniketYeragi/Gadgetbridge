...
public class GBPrefs {
    ...
    public static final String CONTACT_NUMBER_LIST = "contact_number_list";
    public static final String MAC_ADDRESS = "mac_address";
    private static final String AUTO_START = "general_autostartonboot";
    private static final String ENABLE_CALLS = "enable_calls";
    private static final String ENABLE_SMS = "enable_sms";
    private static final String GEMTEC_DEBUG = "gemtec_debug";
    private static final boolean GEMTEC_DEBUG_DEFAULT = true;
    private static final boolean ENABLE_CALLS_DEFAULT = true;
    private static final boolean ENABLE_SMS_DEFAULT = true;
    ...
    public boolean getEnableCalls() {
        return mPrefs.getBoolean(ENABLE_CALLS, ENABLE_CALLS_DEFAULT);
    }

    public boolean getEnableSms() {
        return mPrefs.getBoolean(ENABLE_SMS, ENABLE_SMS_DEFAULT);
    }

    public boolean getGemtecDebugMode() {
        return mPrefs.getBoolean(GEMTEC_DEBUG, GEMTEC_DEBUG_DEFAULT);
    }

    public String getMACAddress() {
        return mPrefs.getString(MAC_ADDRESS, null);
    }
