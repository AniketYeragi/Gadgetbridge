...
import nodomain.freeyourgadget.gadgetbridge.devices.gemtec.GemtecCoordinator;
// import nodomain.freeyourgadget.gadgetbridge.devices.nordic.NordicCoordinator;
...
public class DeviceHelper {
    ...
    private List<DeviceCoordinator> createCoordinators() {
        ...
        result.add(new GemtecCoordinator());
        ...
        // result.add(new NordicCoordinator());
